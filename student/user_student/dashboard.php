          ...
          <table class="table">
            ...
            <tbody>
              <?php 
               ...
               $sid=$_SESSION['sid']."<br>";
               $sd=substr($sid,0,8);
              $sql="SELECT student.StuID,student.ID,student.StudentName,student.address,student.StudentEmail,student.DateofAdmission,student.ContactNumber,student.AltenateNumber,student.fee_balance,class.ClassName,class.Section from student join class on class.ID=student.StudentClass WHERE student.StuID='$sd' ";
