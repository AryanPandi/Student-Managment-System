    ...
    <div class="f">
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php 
                    $sql="SELECT student.StuID,student.ID,student.StudentName,student.StudentEmail,student.DateofAdmission,student.AltenateNumber,student.fee_balance,class.ClassName,class.Section from student join class on class.ID=student.StudentClass ";
