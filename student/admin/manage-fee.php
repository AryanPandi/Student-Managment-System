...
<body>
    ...
    <div class="f">
            <table class="table">
                ...
                <tbody>
                    <?php 
                    $sql="SELECT student.StuID,student.fee_balance,fee_payments.amount,fee_payments.date FROM student join fee_payments WHERE fee_payments.student_id=student.StuID";
